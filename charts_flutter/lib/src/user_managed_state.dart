...
/// events is a [common.SelectionModel], while any user defined selection has
/// to be specified by passing in [selectedSeriesConfig] and
/// [selectedDataConfig].The configuration is converted to a selection model
/// after the series data has been processed.
class UserManagedSelectionModel<D> {
  /// Creates a [UserManagedSelectionModel] that holds [common.SelectionModel].
  ///
